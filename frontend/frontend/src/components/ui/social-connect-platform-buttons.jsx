...
const SocialConnectButtons = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center p-6 md:p-12 font-sans relative z-10">
      ...
      {/* Status indicators */}
      <div className="mt-10 flex flex-wrap justify-center gap-6 text-sm text-gray-400 relative z-10">
      ...
      {/* Floating particles background - Moved inside component for self-containment */}
